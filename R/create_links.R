...
create_links <-
  function(parameters_monkeys,
    ...
    if (parameters_monkeys$task$local_or_server == "server") {
      ...
      # This is done now in set_parameters
      ...
      links_tasks = paste0(parameters_monkeys$task$server_folder_tasks, "/index.html?pid=", parameters_monkeys$task$pid, uid_string)
